...
matches_data = {
    "Vs Los Angeles": [
        ...
        ("DUEL OFENSIVO WON", 107.38, 14.40, None),
        ("DUEL OFENSIVO WON", 112.86, 19.55, None),
        ("DUEL OFENSIVO WON", 100.23, 45.82, None),
        ("DUEL OFENSIVO WON", 89.09, 55.96, None),
        ("DUEL OFENSIVO WON", 62.66, 76.57, None),
        ("DUEL OFENSIVO WON", 35.56, 31.19, None),
        ("DUEL OFENSIVO WON", 40.72, 15.90, None),
        ("DUEL OFENSIVO WON", 54.68, 16.23, None),
        ("DUEL OFENSIVO LOST", 98.40, 76.74, None),
        ("DUEL OFENSIVO LOST", 58.34, 61.44, None),
        ("DUEL OFENSIVO LOST", 51.52, 24.87, None),
        ("DUEL OFENSIVO LOST", 85.93, 23.71, None),
    ],
    "vs Slavia Praha": [
        ("DUEL OFENSIVO WON", 93.25, 8.91, None),
        ("DUEL OFENSIVO WON", 59.17, 19.55, None),
        ("DUEL OFENSIVO LOST", 118.68, 22.55, None),
        ("DUEL OFENSIVO LOST", 116.52, 25.54, None),
        ("DUEL OFENSIVO LOST", 115.52, 64.60, None),
        ("DUEL OFENSIVO LOST", 39.72, 72.42, None),
    ],
    "vs Sockers": [
        ("DUEL OFENSIVO WON", 79.28, 72.08, None),
        ("DUEL OFENSIVO WON", 113.53, 62.77, None),
        ("DUEL OFENSIVO LOST", 54.68, 6.92, None),
        ("DUEL OFENSIVO LOST", 71.14, 1.10, None),
        ("DUEL OFENSIVO LOST", 80.11, 70.92, None),
        ("DUEL OFENSIVO LOST", 90.09, 69.76, None),
        ("DUEL OFENSIVO LOST", 109.70, 66.60, None),
    ],
}
