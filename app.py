...
matches_data = {
    "Vs Los Angeles": [
        ...
        ("DUEL OFENSIVO WON", 89.09, 55.96, "videos/D4 - LA.mp4"),
        ("DUEL OFENSIVO WON", 62.66, 76.57, "videos/D5 - LA.mp4"),
        ("DUEL OFENSIVO WON", 35.56, 31.19, "videos/D6 - LA.mp4"),
        ("DUEL OFENSIVO WON", 40.72, 15.90, "videos/D7 - LA.mp4"),
        ("DUEL OFENSIVO WON", 54.68, 16.23, "videos/D8 - LA.mp4"),
        ("DUEL OFENSIVO LOST", 98.40, 76.74, "videos/D9 - LA.mp4"),
        ("DUEL OFENSIVO LOST", 58.34, 61.44, "videos/D10 - LA.mp4"),
        ("DUEL OFENSIVO LOST", 51.52, 24.87, "videos/D11 - LA.mp4"),
        ("DUEL OFENSIVO LOST", 85.93, 23.71, "videos/D12 - LA.mp4"),
    ],
    "vs Slavia Praha": [
        ("DUEL OFENSIVO WON", 93.25, 8.91, "videos/D1 - SP.mp4"),
        ("DUEL OFENSIVO WON", 59.17, 19.55, "videos/D2 - SP.mp4"),
        ("DUEL OFENSIVO LOST", 118.68, 22.55, "videos/D3 - SP.mp4"),
        ("DUEL OFENSIVO LOST", 116.52, 25.54, "videos/D4 - SP.mp4"),
        ("DUEL OFENSIVO LOST", 115.52, 64.60, "videos/D5 - SP.mp4"),
        ("DUEL OFENSIVO LOST", 39.72, 72.42, "videos/D6 - SP.mp4"),
    ],
    "vs Sockers": [
        ("DUEL OFENSIVO WON", 79.28, 72.08, "videos/D1 - SK.mp4"),
        ("DUEL OFENSIVO WON", 113.53, 62.77, "videos/D2 - SK.mp4"),
        ("DUEL OFENSIVO LOST", 54.68, 6.92, "videos/D3 - SK.mp4"),
        ("DUEL OFENSIVO LOST", 71.14, 1.10, "videos/D4 - SK.mp4"),
        ("DUEL OFENSIVO LOST", 80.11, 70.92, "videos/D5 - SK.mp4"),
        ("DUEL OFENSIVO LOST", 90.09, 69.76, "videos/D6 - SK.mp4"),
